...
crafting.shapedBuilder().name('interfaces_interface_iv')
        ...
        .key('A', item('appliedenergistics2:material', 44))
        .key('F', item('appliedenergistics2:material', 43))
        .key('C', metaitem('conveyor.module.iv'))
        .mirrored()
        .register()

crafting.shapedBuilder().name('interfaces_interface_luv')
        ...
        .key('A', item('appliedenergistics2:material', 44))
        .key('F', item('appliedenergistics2:material', 43))
        .key('C', metaitem('conveyor.module.luv'))
        .mirrored()
        .register()
